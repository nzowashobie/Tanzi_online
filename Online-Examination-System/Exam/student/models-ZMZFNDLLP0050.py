...
class Stu_Question(Question_DB):
    ...
    def __str__(self):
        return f"{self.student.first_name} {self.student.last_name}" + " "+ str(self.qno) +"-Stu_QuestionDB"
...
class StuExam_DB(models.Model):
    ...
    def __str__(self):
        return f"{self.student.first_name} {self.student.last_name}" +" " + str(self.examname) + " " + str(self.qpaper.qPaperTitle) + "-StuExam_DB"
...
class StuResults_DB(models.Model):
    ...
    def __str__(self):
        return f"{self.student.first_name} {self.student.last_name}" +" -StuResults_DB"